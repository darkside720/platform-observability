...
# Pass the r53_health_checks variable from vars.yaml to the inputs
  ...
  # # DDB CloudWatch-specific variables from vars.yaml or ddb_cloudwatch.tf
  # ddb_table_names      = local.vars.ddb_table_names
  # read_capacity_units  = local.vars.read_capacity_units
  # write_capacity_units = local.vars.write_capacity_units
  # alarm_threshold      = local.vars.alarm_threshold
  # alarm_actions        = local.vars.alarm_actions
  # alarm_description    = local.vars.alarm_description
}
